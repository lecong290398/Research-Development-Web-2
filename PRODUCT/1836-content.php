                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade" id="service-two">
                        <form action="#">
                            ...
                            <div class="form-group">
                                <label for="Comment">Comment <span class="form-required" title="This field is required.">*</span></label>
                                <textarea class="form-control" id="Comment" cols="60" rows="5"></textarea>
                            </div>
